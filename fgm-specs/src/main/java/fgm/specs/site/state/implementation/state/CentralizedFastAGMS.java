...
//import fgm.specs.site.CentralizedLocalStatistic;
//import fgm.specs.data.StreamRecord;
//import fgm.specs.site.LocalStatistic_old;
//import org.apache.commons.rng.UniformRandomProvider;
//import org.apache.commons.rng.simple.RandomSource;
//
//public class CentralizedFastAGMS implements CentralizedLocalStatistic {
...
//
//
//    public CentralizedFastAGMS(int depth, int buckets) {
//        this.depth = depth;
//        this.buckets = buckets;
//        counts = new double[depth][buckets];
//    }
//
...
//            if(record.getKey() instanceof Long) {
//                int hash = hash(d, ( (Long) record.getKey() ).longValue());
//                int xi = fourwise(d,  ( (Long) record.getKey() ).longValue());
//                double value = 0.5;
//                counts[d][hash] +=  (value)*((double)xi);
//            }
//        }
//    }
//
//    public void updateNegative(StreamRecord record) {
//        for(int d = 0; d < depth; d++){
//            if(record.getKey() instanceof Long) {
//                int hash = hash(d, ( (Long) record.getKey() ).longValue());
//                int xi = fourwise(d,  ( (Long) record.getKey() ).longValue());
...
//
//    @Override
//    public void update(StreamRecord record, int value) {
//        for(int d = 0; d < depth; d++){
//            if(record.getKey() instanceof Long) {
//                int hash = hash(d, ( (Long) record.getKey() ).longValue());
//                int xi = fourwise(d,  ( (Long) record.getKey() ).longValue());
//                counts[d][hash] += (double)value*xi;
//            }
//        }
//    }
//
//    public void addLocalStatistics(LocalStatistic_old sketch) {
//        if(sketch instanceof  CentralizedFastAGMS) {
//            for (int i = 0; i < ((CentralizedFastAGMS) sketch).depth(); i++) {
//                for (int j = 0; j < ((CentralizedFastAGMS) sketch).buckets(); j++) {
//                    counts[i][j] = counts[i][j] + ((CentralizedFastAGMS) sketch).getSketchElement(i, j);
//                }
//            }
//        }
//    }
//
//    public void divideWithNumOfSites(int k) {
//        double newK = (double) k;
//        double[][] newCounts = new double[this.depth][this.buckets];
//        for(int i = 0; i < this.depth; i++) {
//            for(int j = 0; j < this.buckets; j++) {
//                newCounts[i][j] = this.counts[i][j]/newK;
//            }
//        }
//        this.setCounts(newCounts);
//    }
//
//    public CentralizedFastAGMS getSubtractionResultOfStatistics(LocalStatistic_old sketch) {
//        CentralizedFastAGMS result = Factory.getStatistic();
//        result.setCounts(this.getCounts());
//        if(sketch instanceof  CentralizedFastAGMS) {
//            for (int i = 0; i < ((CentralizedFastAGMS) sketch).depth(); i++) {
//                for (int j = 0; j < ((CentralizedFastAGMS) sketch).buckets(); j++) {
//                    result.counts[i][j] = result.counts[i][j] - ((CentralizedFastAGMS) sketch).getSketchElement(i, j);
//                }
//            }
//        }
//        return result;
//    }
//
//    private CentralizedFastAGMS newInstance() {
//        return new CentralizedFastAGMS(this.depth, this.buckets);
//    }
//
//    public int depth() {
//        return this.depth;
...
//    }
//
//    public void setCounts(CentralizedFastAGMS fastAGMS) {
//        for (int i = 0; i < this.depth; i++) {
//            for (int j = 0; j < this.buckets; j++) {
//                counts[i][j] = fastAGMS.getSketchElement(i, j);
//            }
//        }
//    }
//
//    public CentralizedFastAGMS deepCopy() {
//        CentralizedFastAGMS fastAGMS = this.newInstance(); //to-do create deep copy with serdes
//        double[][] newCounts = new double[this.depth][this.buckets];
//        for(int i = 0; i < this.depth; i++) {
//            if (this.buckets >= 0)
...
//        double[][] newCounts = new double[depth][buckets];
//        for (int i = 0; i < this.depth; i++) {
//            for (int j = 0; j < this.buckets; j++) {
...
//        double result = counts[i][j];
//        return result;
//    }
//
//    public void normalize(int numOfNodes) {
//        double numOfNodesToDouble = (double)numOfNodes;
//        double[][] newCounts = new double[this.depth][this.buckets];
//
//        for(int i = 0; i < this.depth; ++i) {
//            for(int j = 0; j < this.buckets; ++j) {
//                newCounts[i][j] = this.counts[i][j] / numOfNodesToDouble;
//            }
//        }
//
//        this.setCounts(newCounts);
